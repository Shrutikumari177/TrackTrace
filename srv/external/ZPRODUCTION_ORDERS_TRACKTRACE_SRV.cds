/* checksum : 6da992dc138de4e3496c8e50df0baa21 */
@cds.external : true
@m.IsDefaultEntityContainer : 'true'
@sap.message.scope.supported : 'true'
@sap.supported.formats : 'atom json xlsx'
service ZPRODUCTION_ORDERS_TRACKTRACE_SRV {};
...
entity ZPRODUCTION_ORDERS_TRACKTRACE_SRV.FunctionMessageSet {
  @sap.unicode : 'false'
...
@sap.addressable : 'false'
@sap.content.version : '1'
entity ZPRODUCTION_ORDERS_TRACKTRACE_SRV.ReleaseMessageSet {
  @sap.unicode : 'false'
  @sap.label : 'Message text'
  @sap.creatable : 'false'
  @sap.updatable : 'false'
...
entity ZPRODUCTION_ORDERS_TRACKTRACE_SRV.A_PlannedOrder {
...
entity ZPRODUCTION_ORDERS_TRACKTRACE_SRV.A_ProductionOrder {
  @sap.display.format : 'UpperCase'
  ...
  to_ProductionOrderComponent : Association to many ZPRODUCTION_ORDERS_TRACKTRACE_SRV.A_ProductionOrderComponent {  };
  to_ProductionOrderItem : Association to many ZPRODUCTION_ORDERS_TRACKTRACE_SRV.A_ProductionOrderItem {  };
  to_ProductionOrderOperation : Association to many ZPRODUCTION_ORDERS_TRACKTRACE_SRV.A_ProductionOrderOperation {  };
  to_ProductionOrderStatus : Association to many ZPRODUCTION_ORDERS_TRACKTRACE_SRV.A_ProductionOrderStatus {  };
  to_ProductionRsceTools : Association to many ZPRODUCTION_ORDERS_TRACKTRACE_SRV.A_ProductionRsceTools {  };
};
...
entity ZPRODUCTION_ORDERS_TRACKTRACE_SRV.A_ProductionOrderComponent {
  @sap.display.format : 'NonNegative'
  @sap.label : 'Reservation'
  @sap.quickinfo : 'Number of reservation/dependent requirements'
...
entity ZPRODUCTION_ORDERS_TRACKTRACE_SRV.A_ProductionOrderItem {
  @sap.display.format : 'UpperCase'
...
entity ZPRODUCTION_ORDERS_TRACKTRACE_SRV.A_ProductionOrderOperation {
  @sap.display.format : 'NonNegative'
  @sap.label : 'Order Internal ID'
...
entity ZPRODUCTION_ORDERS_TRACKTRACE_SRV.A_ProductionOrderStatus {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Order'
...
entity ZPRODUCTION_ORDERS_TRACKTRACE_SRV.A_ProductionRsceTools {
  @sap.display.format : 'NonNegative'
...
@sap.deletable : 'false'
@sap.content.version : '1'
@sap.label : 'new prod order'
entity ZPRODUCTION_ORDERS_TRACKTRACE_SRV.zproductionorder_n {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Production Order'
  @sap.quickinfo : 'Manufacturing Order ID'
  key ProductionOrder : String(12) not null;
...
@cds.external : true
action ZPRODUCTION_ORDERS_TRACKTRACE_SRV.ReleaseProductionOrder(
  ManufacturingOrder : LargeString
) returns ZPRODUCTION_ORDERS_TRACKTRACE_SRV.ReleaseMessageSet;

@cds.external : true
action ZPRODUCTION_ORDERS_TRACKTRACE_SRV.ReleaseProductionOrderOpr(
